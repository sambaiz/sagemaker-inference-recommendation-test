...
def _make_train_loader(batch_size, is_distributed, **kwargs):
  dataset = datasets.MNIST('train_data', train=True, transform=transforms.ToTensor(), download=True)
...
def _make_test_loader(batch_size, **kwargs):
  dataset = datasets.MNIST('test_data', train=False, transform=transforms.ToTensor(), download=True)
...
def train(args):
  ...
  train_loader = _make_train_loader(args.batch_size, is_distributed, **kwargs)
  test_loader = _make_test_loader(args.test_batch_size, **kwargs)
